...
# This line is CRITICAL to activate the tabbed panels
...
.center[
<img src="images/Copernicus Programme.png" style="width: 50%; border-radius: 10px; shadow: 5px;" />
<p style="font-size: 10px; color: grey;">[Credits: ESA]. Source: Copernicus SentiWiki (2024).</p>
]
]
...
.center[
<img src="images/Artist's view of the deployed Sentinel-1 spacecraft.jpeg" style="width: 45%;" />
<p style="font-size: 10px; color: grey;">Artist's view of the deployed Sentinel-1 spacecraft. Image Credit: ESA/TAS-I. Source: NASA Earthdata (2023).</p>
]
]
...
.center[
<img src="images/SAR.png" style="width: 50%;" />
<p style="font-size: 10px; color: grey;">SAR active microwave sensing mechanism. Source: Gnosys Technology (2023).</p>
]
]
...
/* 重点内容加粗样式 */
b, strong {
  color: #005587; /* 使用深蓝色标注重点 */
}

/* Panelset 选项卡样式自定义 */
.panelset {
   --panel-tab-foreground: #666;
